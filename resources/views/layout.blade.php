                    ...
                    <ul class="list-unstyled topnav-menu float-right mb-0">
                        ...
                        <li class="dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                                ...
                                <!-- item-->
                                <a href="{{ Route('trang-chu') }}" class="dropdown-item notify-item">
                                    <i class="fe-user"></i>
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                <a href="{{ Route('cau-hoi.danh-sach') }}">
                                    <i class="la la-question-circle"></i>Câu hỏi <div class="arrow-down"></div></a>
                                <ul class="submenu">
                                    <li>
                            ...
                            <li class="has-submenu">
                                ...
                                <li>
                                        <a href="{{ Route('nguoi-choi.them-moi') }}"> Thêm mới người chơi </a>
                                </li>
                                </ul>
                            </li>

                            <li class="has-submenu">
                                <a href="{{Route('goi-credit.danh-sach')}}"> <i class="la la-credit-card"></i>Credit <div class="arrow-down"></div></a>
                                <ul class="submenu megamenu">
                                    <li>
                             ...
                             <li class="has-submenu">
                                <a href="{{Route('luot-choi.danh-sach')}}"> <i class="la la-cubes"></i>Lượt Chơi <div class="arrow-down"></div></a>
                            </li>
                             <li class="has-submenu">
                                <a href="{{Route('cau-hinh.danh-sach-app')}}"> <i class="la la-cogs"></i>Cấu hình<div class="arrow-down"></div></a>
                                <ul class="submenu megamenu">
                                    <ul>
                                    <li>
                                        <a href="{{ Route('cau-hinh.danh-sach-app') }} "> Danh sách app </a></li>
                                    </li>
                                    </ul>
                                    <ul>
                                    <li>
                                        <a href="{{ Route('cau-hinh.danh-sach-diem-cau-hoi') }}"> Danh sách điểm câu hỏi </a>
                                    </li>
                                    </ul>
                                    <ul>
                                    <li>
                                        <a href="{{ Route('cau-hinh.danh-sach-tro-giup') }}"> Danh sách trợ giúp </a>
                                    </li>
                                    </ul>
                                </ul>
                            </li>
